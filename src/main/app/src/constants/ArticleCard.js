...
const ArticleCard = ({ activityKey, title, url, description, updateActivity, publisher }) => {
  ...
  return (
    <Card className="m-3 classes.root" variant="outlined">
      <CardActionArea href={url}>
        <CardContent>
          <Typography className={classes.title} color="textSecondary" gutterBottom>{publisher}</Typography>
